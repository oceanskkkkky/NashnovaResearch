...
def run_main():
    ...
    if hithink_trade_date and hithink_trade_date != TARGET:
        FAILURES.append({
            ...
            "handling": "不作为当日龙虎榜；改用WeStock lhb --date 2026-08-25 --raw",
        })
    ...
    market_payload = {
        ...
        "query_context": {
            ...
            "requested_at": "2026-08-25T21:28:00+08:00",
            "generated_at": generated_at,
            "market_state": "盘后",
            "completeness_basis": "目标日为交易日，且市场总览和板块K线均覆盖2026-08-25收盘",
        },
        ...
        "limitations": [
            ...
            "hithink-finance龙虎榜接口返回2026-08-24，未作为2026-08-25当日龙虎榜使用",
